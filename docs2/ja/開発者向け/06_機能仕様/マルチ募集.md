...
詳細は `docs2/ja/開発者向け/05_データベース/スキーマ/guild_master/guild_environments.md` と `docs2/ja/開発者向け/03_開発ルール/セキュリティ.md` を参照してください。
...
- `docs2/ja/開発者向け/05_データベース/スキーマ/worker/battle_recruitment_dismissals.md`
- `docs2/ja/開発者向け/05_データベース/スキーマ/worker/scheduled_task_dismissals.md`
- `docs2/ja/開発者向け/05_データベース/スキーマ/guild_master/battle_recruitment_schedule_dismissals.md`
