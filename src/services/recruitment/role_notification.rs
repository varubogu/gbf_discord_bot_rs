...
/// ロール通知サービス
pub struct RoleNotificationService<A, Q>
where
    A: AllRecruitmentNotificationRolesRepository,
    Q: QuestRecruitmentNotificationRolesRepository,
{
    all_roles_repo: A,
    quest_roles_repo: Q,
}

impl<A, Q> RoleNotificationService<A, Q>
where
    A: AllRecruitmentNotificationRolesRepository,
    Q: QuestRecruitmentNotificationRolesRepository,
{
    pub fn new(all_roles_repo: A, quest_roles_repo: Q) -> Self {
        Self {
            all_roles_repo,
            quest_roles_repo,
        }
    ...
    pub async fn get_quest_recruitment_roles(
        ...
        Vec<crate::models::entities::guild_master::quest_recruitment_notification_roles::Model>,
    > {
        self.quest_roles_repo
            .find_by_guild_with_txn(txn, guild_id)
            .await
