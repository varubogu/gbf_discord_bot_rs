...
pub use guild_channels::GuildChannelsTable;
...
pub use guild_quest_disables::GuildQuestDisablesTable;
...
pub fn table_registrations() -> Vec<TableRegistration> {
    vec![
        ...
        TableRegistration::new::<GuildChannelsTable>(),
        ...
        TableRegistration::new::<GuildQuestDisablesTable>(),
    ]
}
