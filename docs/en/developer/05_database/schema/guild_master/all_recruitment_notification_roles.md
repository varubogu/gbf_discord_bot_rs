# guild_master.all_recruitment_notification_roles Table Design

## Overview

- Schema: `guild_master`
- Table: `all_recruitment_notification_roles`
- Source: `src/models/entities/guild_master/all_recruitment_notification_roles.rs`
