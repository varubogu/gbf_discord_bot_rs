# guild_master.battle_recruitment_schedule_dismissals Table Design

## Overview

- Schema: `guild_master`
- Table: `battle_recruitment_schedule_dismissals`
- Source: `src/models/entities/guild_master/battle_recruitment_schedule_dismissals.rs`
...
| `input_type` | `i32` | NO |  |
| `dismissal_time` | `Option<TimeTime>` | YES |  |
