# guild_master.guild_spreadsheet_imports Table Design

## Overview

- Schema: `guild_master`
- Table: `guild_spreadsheet_imports`
- Source: `src/models/entities/guild_master/guild_spreadsheet_imports.rs`
