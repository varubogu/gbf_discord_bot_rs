...
- Concrete `SeaOrm*Repository` types are composed at DI/scheduler composition points (`src/di/repositories.rs`, `src/facades/schedule/scheduler_task_dispatch_facade.rs`).
