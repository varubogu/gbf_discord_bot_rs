...
- `docs/develop/architecture/`: アーキテクチャ・設計指針（抽象的な概念レベル）
- `docs/develop/features/`: 機能別設計書（機能要件・仕様）
- `docs/develop/database/`: データベース実装設計書
- `docs/develop/rules/`: コーディングルール、開発ルール
